...
#实际接口数量
# api_count_probability(96)

#执行测试用例
runner = BeautifulReport(testCase)
#生成测试报告
runner.report(description='%s运输下单V3.1.0接口测试报告'%environment_name, filename='%s运输下单V3.1.0接口测试报告'%environment_name + date + '.html', report_dir=report_dir)
